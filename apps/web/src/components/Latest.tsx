...
function LatestInner({ initialData, initialError, cdn, initialDevice }: Props) {
	...
	return (
		<div className="space-y-6">
			<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 max-w-7xl mx-auto">
				...
				<div className="flex bg-slate-100 p-1 rounded-xl border border-slate-200 self-start sm:self-auto shrink-0 shadow-sm">
					<button
						type="button"
